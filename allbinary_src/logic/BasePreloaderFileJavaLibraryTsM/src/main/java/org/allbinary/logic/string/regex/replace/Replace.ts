...
//not game specific package import { J2SEUtil } from '../../../../../../org/allbinary/J2SEUtil.js';
      const J2SEUtil = globalThis.org.allbinary.J2SEUtil;
...
console.log("New String: " +testString);
    ...
    private readonly j2seUtil: J2SEUtil = J2SEUtil.getInstance()!;
...
public constructor (hashMap: HashMap<any, any>){
    ...
    var keyArray: any[] = this.j2seUtil!.getHashMapAsArray(this.hashMap)!;;
...
begin2= replace.indexOf(nextSecondKey, index);
    ...
    var end2: number = begin2 +nextSecondKey!.length;;

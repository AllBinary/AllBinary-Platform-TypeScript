...
//not GWT import - same folder const PermissionItemsEntityInterface = globalThis.org.allbinary.data.tables.user.commerce.inventory.item.permissions.PermissionItemsEntityInterface;

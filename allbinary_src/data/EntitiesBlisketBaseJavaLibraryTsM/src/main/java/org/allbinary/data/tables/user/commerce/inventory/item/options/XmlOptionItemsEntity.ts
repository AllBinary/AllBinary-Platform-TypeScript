...
//not GWT import - same folder const XmlOptionItemsEntityInterface = globalThis.org.allbinary.data.tables.user.commerce.inventory.item.options.XmlOptionItemsEntityInterface;

...
//not GWT import - same folder const SpecialItemsEntity = globalThis.org.allbinary.data.tables.user.commerce.inventory.item.special.SpecialItemsEntity;
...
private constructor (){
    ...
    public getSpecialItemsEntityInstance(): SpecialItemsEntity{

...
//not GWT import - same folder const PermissionItemsEntity = globalThis.org.allbinary.data.tables.user.commerce.inventory.item.permissions.PermissionItemsEntity;

...
//not GWT import - same folder const StoreFrontsEntityInterface = globalThis.org.allbinary.data.tables.context.module.storefronts.StoreFrontsEntityInterface;
...
keysAndValues!.put(StoreFrontData.getInstance()!.NAME, name);
    ...
    public getStoreFrontNames(): BasicArrayList{

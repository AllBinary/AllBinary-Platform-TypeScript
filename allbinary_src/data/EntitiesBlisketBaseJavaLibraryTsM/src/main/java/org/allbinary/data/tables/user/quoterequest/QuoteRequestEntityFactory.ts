...
//not GWT import - same folder const QuoteRequestEntity = globalThis.org.allbinary.data.tables.user.quoterequest.QuoteRequestEntity;
...
private constructor (){
    ...
    public getQuoteRequestEntityInstance(): QuoteRequestEntity{

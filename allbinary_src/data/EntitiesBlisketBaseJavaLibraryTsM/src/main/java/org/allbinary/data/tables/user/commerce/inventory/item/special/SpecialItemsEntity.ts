...
//not GWT import const SpecialItemsEntityInterface = globalThis.org.allbinary.data.tables.user.commerce.inventory.item.special.SpecialItemsEntityInterface;

...
//not GWT import - same folder const OrderHistoryEntity = globalThis.org.allbinary.data.tables.user.commerce.inventory.order.OrderHistoryEntity;

                
export class OrderHistoryEntityFactory
            extends Object
         {

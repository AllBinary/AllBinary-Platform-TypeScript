...
//not game specific package import { AbPathUtil } from '../../../../../../org/allbinary/logic/io/path/AbPathUtil.js';
      const AbPathUtil = globalThis.org.allbinary.logic.io.path.AbPathUtil;

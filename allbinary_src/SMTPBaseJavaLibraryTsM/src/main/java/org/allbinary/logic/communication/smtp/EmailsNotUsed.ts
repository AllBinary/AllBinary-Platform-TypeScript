...
//not game specific package import { BasicErrorNodeUtil } from '../../../../../org/allbinary/data/tree/dom/BasicErrorNodeUtil.js';
      const BasicErrorNodeUtil = globalThis.org.allbinary.data.tree.dom.BasicErrorNodeUtil;

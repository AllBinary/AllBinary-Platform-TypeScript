...
//not game specific package import { BasicTransformer } from '../org/allbinary/logic/visual/transform/BasicTransformer.js';
      const BasicTransformer = globalThis.org.allbinary.logic.visual.transform.BasicTransformer;

...
export class AddValidationUserView extends HttpContextView
...
this.user= NewUserFactory.getInstance(transformInfoInterface)
    ...
    public isValid(): Boolean{
        ...
        try {
                        ...
                        if(org.allbinary.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(org.allbinary.logic.communication.log.config.type.LogConfigTypeFactory.getInstance()!.VIEW))
                                    ...
                                    {
                                    put("User already in existance.", this, commonStrings!.IS_VALID)
    ...
    var stringBuffer: StringMaker = new StringMaker();
                        ...
                        if(org.allbinary.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(org.allbinary.logic.communication.log.config.type.LogConfigTypeFactory.getInstance()!.VIEW))
                                    ...
                                    {
                                    put("User already exists", this, "validationInfo()")

                                    }
                                
append("The User Name you selected is already in use.<br/>  Please select another User Name.<br />")

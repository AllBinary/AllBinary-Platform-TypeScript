...
this.this.getFormData(this.getPageContext()!.getRequest() as HttpServletRequest)
}
...
this.this.setPaymentGatewayPrimaryKey(PaymentGatewayPrimaryKey(storeName, gatewayName))
}

...
//not GWT import - same folder const GlobalsView = globalThis.views.business.context.modules.storefront.customizer.includes.globals.GlobalsView;

                
export class InsertGlobalsValidationView extends GlobalsView implements ValidationComponentInterface {

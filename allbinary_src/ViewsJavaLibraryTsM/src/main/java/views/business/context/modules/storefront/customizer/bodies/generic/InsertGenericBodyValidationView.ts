...
//not GWT import - same folder const GenericBodyCustomizerView = globalThis.views.business.context.modules.storefront.customizer.bodies.generic.GenericBodyCustomizerView;

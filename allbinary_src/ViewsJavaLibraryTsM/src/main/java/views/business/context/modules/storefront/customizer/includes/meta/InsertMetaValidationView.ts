...
//not GWT import - same folder const MetaView = globalThis.views.business.context.modules.storefront.customizer.includes.meta.MetaView;

                
export class InsertMetaValidationView extends MetaView implements ValidationComponentInterface {

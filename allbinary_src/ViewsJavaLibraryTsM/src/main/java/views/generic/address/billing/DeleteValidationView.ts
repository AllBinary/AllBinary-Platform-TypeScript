...
//not GWT import const BillingAddressView = globalThis.views.generic.address.billing.BillingAddressView;

                
export class DeleteValidationView extends BillingAddressView implements ValidationComponentInterface {

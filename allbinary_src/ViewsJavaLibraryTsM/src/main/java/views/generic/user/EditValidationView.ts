...
//not GWT import const UserView = globalThis.views.generic.user.UserView;

                
export class EditValidationView extends UserView implements ValidationComponentInterface {

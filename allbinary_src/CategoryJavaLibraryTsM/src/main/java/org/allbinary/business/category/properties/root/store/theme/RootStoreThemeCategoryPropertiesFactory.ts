...
//not GWT import - same folder const RootStoreThemeCategoryProperties = globalThis.org.allbinary.business.category.properties.root.store.theme.RootStoreThemeCategoryProperties;

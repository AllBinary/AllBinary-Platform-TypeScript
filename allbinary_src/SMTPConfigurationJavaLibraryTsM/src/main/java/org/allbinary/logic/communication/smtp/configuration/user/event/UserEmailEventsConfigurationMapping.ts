...
//not GWT import - same folder const UserEmailEventsConfigurationInterfaceimport { UserEmailEventsConfigurationData } from './UserEmailEventsConfigurationData.js';

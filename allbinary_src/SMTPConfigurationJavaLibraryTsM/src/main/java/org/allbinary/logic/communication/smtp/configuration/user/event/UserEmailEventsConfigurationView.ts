...
//not GWT import - same folder const UserEmailEventsConfiguration = globalThis.org.allbinary.logic.communication.smtp.configuration.user.event.UserEmailEventsConfiguration;
...
//not GWT import - same folder const UserEmailEventConfigurationView = globalThis.org.allbinary.logic.communication.smtp.configuration.user.event.UserEmailEventConfigurationView;

                import { UserEmailEventsConfigurationMapping } from './UserEmailEventsConfigurationMapping.js';
//not GWT import - same folder const UserEmailEventsConfigurationMapping = globalThis.org.allbinary.logic.communication.smtp.configuration.user.event.UserEmailEventsConfigurationMapping;

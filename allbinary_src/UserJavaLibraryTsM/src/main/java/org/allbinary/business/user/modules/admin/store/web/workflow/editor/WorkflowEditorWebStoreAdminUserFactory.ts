...
//not GWT import - same folder const WorkflowEditorWebStoreAdminUser = globalThis.org.allbinary.business.user.modules.admin.store.web.workflow.editor.WorkflowEditorWebStoreAdminUser;

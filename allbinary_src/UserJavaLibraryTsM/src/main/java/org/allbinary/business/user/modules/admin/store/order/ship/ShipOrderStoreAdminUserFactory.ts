...
//not GWT import - same folder const ShipOrderStoreAdminUser = globalThis.org.allbinary.business.user.modules.admin.store.order.ship.ShipOrderStoreAdminUser;

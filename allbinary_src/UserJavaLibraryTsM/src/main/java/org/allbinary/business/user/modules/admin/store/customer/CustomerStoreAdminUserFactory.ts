...
//not GWT import const UserInterface = globalThis.org.allbinary.business.user.UserInterface;
        ...
        import { CustomerStoreAdminUser } from './CustomerStoreAdminUser.js';
//not GWT import - same folder const CustomerStoreAdminUser = globalThis.org.allbinary.business.user.modules.admin.store.customer.CustomerStoreAdminUser;

                
export class CustomerStoreAdminUserFactory
            extends Object

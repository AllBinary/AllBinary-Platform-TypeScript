...
//not GWT import const UserInterface = globalThis.org.allbinary.business.user.UserInterface;
        ...
        import { ViewEditorWebStoreAdminUser } from './ViewEditorWebStoreAdminUser.js';
//not GWT import - same folder const ViewEditorWebStoreAdminUser = globalThis.org.allbinary.business.user.modules.admin.store.web.view.editor.ViewEditorWebStoreAdminUser;

                
export class ViewEditorWebStoreAdminUserFactory
            extends Object

...
//not GWT import - same folder const PaymentStoreAdminUser = globalThis.org.allbinary.business.user.modules.admin.store.payment.PaymentStoreAdminUser;
...
public constructor (){
    ...
    public getInstance(): UserInterface{
                        ...
                        return new PaymentStoreAdminUser();
    ...
    public getInstance(hashMap: HashMap<any, any>): UserInterface{
                        ...
                        //if statement needs to be on the same line and ternary does not work the same way.
                        return new PaymentStoreAdminUser(hashMap);

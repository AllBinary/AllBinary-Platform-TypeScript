...
//not GWT import - same folder const SubscriberUser = globalThis.org.allbinary.business.user.modules.customer.subscriber.SubscriberUser;
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>): UserInterface{
                        ...
                        //if statement needs to be on the same line and ternary does not work the same way.
                        return new SubscriberUser(hashMap);

...
//not GWT import - same folder const WholesaleUser = globalThis.org.allbinary.business.user.modules.customer.wholesale.WholesaleUser;
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>): UserInterface{
                        ...
                        //if statement needs to be on the same line and ternary does not work the same way.
                        return new WholesaleUser(hashMap);

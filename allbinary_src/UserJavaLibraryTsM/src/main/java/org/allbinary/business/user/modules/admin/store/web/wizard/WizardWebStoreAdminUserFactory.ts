...
//not GWT import const UserInterface = globalThis.org.allbinary.business.user.UserInterface;
        ...
        import { WizardWebStoreAdminUser } from './WizardWebStoreAdminUser.js';
//not GWT import - same folder const WizardWebStoreAdminUser = globalThis.org.allbinary.business.user.modules.admin.store.web.wizard.WizardWebStoreAdminUser;

                
export class WizardWebStoreAdminUserFactory
            extends Object

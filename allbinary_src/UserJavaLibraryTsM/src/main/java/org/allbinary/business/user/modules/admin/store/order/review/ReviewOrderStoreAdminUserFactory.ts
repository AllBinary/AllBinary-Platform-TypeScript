...
//not GWT import const UserInterface = globalThis.org.allbinary.business.user.UserInterface;
        ...
        import { ReviewOrderStoreAdminUser } from './ReviewOrderStoreAdminUser.js';
//not GWT import - same folder const ReviewOrderStoreAdminUser = globalThis.org.allbinary.business.user.modules.admin.store.order.review.ReviewOrderStoreAdminUser;

                
export class ReviewOrderStoreAdminUserFactory
            extends Object

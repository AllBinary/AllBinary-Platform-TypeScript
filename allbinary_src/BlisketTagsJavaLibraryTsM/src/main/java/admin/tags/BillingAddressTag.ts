...
//not game specific package import { BillingAddressHelperFactory } from '../../admin/taghelpers/BillingAddressHelperFactory.js';
      const BillingAddressHelperFactory = globalThis.admin.taghelpers.BillingAddressHelperFactory;
...
this.value= value;
    ...
    var anyType: any = new BillingAddressHelperFactory().getInstance(this.getPropertiesHashMap(), this.pageContext)!;;

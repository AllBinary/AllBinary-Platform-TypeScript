...
//not game specific package import { PaymentHelperFactory } from '../../admin/taghelpers/PaymentHelperFactory.js';
      const PaymentHelperFactory = globalThis.admin.taghelpers.PaymentHelperFactory;

...
export class InitHelperFactory
            extends Object
        
                , TagHelperFactoryInterface {
        

    private static readonly CLASSNAME: string = "admin.taghelpers.InitHelper";
        
        

    private static readonly FACTORYNAME: string = "InitHelperFactory";

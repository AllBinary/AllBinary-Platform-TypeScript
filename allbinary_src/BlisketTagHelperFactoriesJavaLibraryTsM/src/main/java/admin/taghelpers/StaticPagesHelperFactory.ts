...
//not GWT import - same folder const TagHelperFactoryimport { StaticPagesHelper } from './StaticPagesHelper.js';
//not GWT import - same folder const StaticPagesHelper
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new StaticPagesHelper(hashMap, pageContext);

...
//not GWT import - same folder const TagHelperFactoryimport { WorkFlowHelper } from './WorkFlowHelper.js';
//not GWT import - same folder const WorkFlowHelper
export class WorkFlowRequestHelperFactory extends TagHelperFactory {

...
//not GWT import - same folder const TagHelperFactory = globalThis.admin.taghelpers.TagHelperFactory;
                ...
                import { BasicGroupItemsHelper } from './BasicGroupItemsHelper.js';
//not GWT import - same folder const BasicGroupItemsHelper = globalThis.admin.taghelpers.BasicGroupItemsHelper;

                
export class BasicGroupItemsHelperFactory extends TagHelperFactory {
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new BasicGroupItemsHelper(hashMap, pageContext);

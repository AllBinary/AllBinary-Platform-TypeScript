...
//not GWT import - same folder const TagHelperFactory = globalThis.admin.taghelpers.TagHelperFactory;
                ...
                import { PaymentProcessHelper } from './PaymentProcessHelper.js';
//not GWT import - same folder const PaymentProcessHelper = globalThis.admin.taghelpers.PaymentProcessHelper;

                
export class PaymentProcessHelperFactory extends TagHelperFactory {
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new PaymentProcessHelper(hashMap, pageContext);

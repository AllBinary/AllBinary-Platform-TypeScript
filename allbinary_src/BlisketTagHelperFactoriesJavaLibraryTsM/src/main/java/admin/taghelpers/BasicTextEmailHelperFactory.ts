...
//not GWT import - same folder const TagHelperFactory = globalThis.admin.taghelpers.TagHelperFactory;
                ...
                import { BasicTextEmailHelper } from './BasicTextEmailHelper.js';
//not GWT import - same folder const BasicTextEmailHelper = globalThis.admin.taghelpers.BasicTextEmailHelper;

                
export class BasicTextEmailHelperFactory extends TagHelperFactory {
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new BasicTextEmailHelper(hashMap, pageContext);

...
//not GWT import - same folder const TagHelperFactory = globalThis.admin.taghelpers.TagHelperFactory;
                ...
                import { OrderHistoryRequestHelper } from './OrderHistoryRequestHelper.js';
//not GWT import - same folder const OrderHistoryRequestHelper = globalThis.admin.taghelpers.OrderHistoryRequestHelper;

                
export class OrderHistoryRequestHelperFactory extends TagHelperFactory {

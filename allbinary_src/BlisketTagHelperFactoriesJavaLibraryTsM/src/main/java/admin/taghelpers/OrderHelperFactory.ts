...
//not GWT import - same folder const TagHelperFactoryimport { OrderHelper } from './OrderHelper.js';
//not GWT import - same folder const OrderHelper
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new OrderHelper(hashMap, pageContext);

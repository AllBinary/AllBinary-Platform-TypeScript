...
//not GWT import - same folder const TagHelperFactory = globalThis.admin.taghelpers.TagHelperFactory;
                ...
                import { PaymentGatewayHelper } from './PaymentGatewayHelper.js';
//not GWT import - same folder const PaymentGatewayHelper = globalThis.admin.taghelpers.PaymentGatewayHelper;

                
export class PaymentGatewayHelperFactory extends TagHelperFactory {
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new PaymentGatewayHelper(hashMap, pageContext);

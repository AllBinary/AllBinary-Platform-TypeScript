...
//not GWT import - same folder const TagHelperFactoryimport { ShippingHelper } from './ShippingHelper.js';
//not GWT import - same folder const ShippingHelper
export class ShippingHelperFactory extends TagHelperFactory {

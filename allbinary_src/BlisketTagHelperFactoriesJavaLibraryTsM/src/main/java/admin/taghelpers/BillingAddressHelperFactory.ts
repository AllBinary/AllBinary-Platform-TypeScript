...
//not GWT import - same folder const TagHelperFactory = globalThis.admin.taghelpers.TagHelperFactory;
                ...
                import { BillingAddressHelper } from './BillingAddressHelper.js';
//not GWT import - same folder const BillingAddressHelper = globalThis.admin.taghelpers.BillingAddressHelper;

                
export class BillingAddressHelperFactory extends TagHelperFactory {
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new BillingAddressHelper(hashMap, pageContext);

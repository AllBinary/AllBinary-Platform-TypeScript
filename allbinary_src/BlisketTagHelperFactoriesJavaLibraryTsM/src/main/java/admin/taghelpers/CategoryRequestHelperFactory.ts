...
//not GWT import - same folder const TagHelperFactory = globalThis.admin.taghelpers.TagHelperFactory;
                ...
                import { CategoryRequestHelper } from './CategoryRequestHelper.js';
//not GWT import - same folder const CategoryRequestHelper = globalThis.admin.taghelpers.CategoryRequestHelper;

                
export class CategoryRequestHelperFactory extends TagHelperFactory {
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new CategoryRequestHelper(hashMap, pageContext);

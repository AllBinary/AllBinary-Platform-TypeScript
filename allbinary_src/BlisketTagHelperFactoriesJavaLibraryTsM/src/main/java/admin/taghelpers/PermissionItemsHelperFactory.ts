...
//not GWT import - same folder const TagHelperFactory = globalThis.admin.taghelpers.TagHelperFactory;
                ...
                import { PermissionItemsHelper } from './PermissionItemsHelper.js';
//not GWT import - same folder const PermissionItemsHelper = globalThis.admin.taghelpers.PermissionItemsHelper;
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new PermissionItemsHelper(hashMap, pageContext);

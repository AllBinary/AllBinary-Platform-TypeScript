...
//not GWT import - same folder const TagHelperFactoryimport { PermissionItemsHelper } from './PermissionItemsHelper.js';
//not GWT import - same folder const PermissionItemsHelper

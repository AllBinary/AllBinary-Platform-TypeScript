...
//not GWT import - same folder const TagHelperFactory = globalThis.admin.taghelpers.TagHelperFactory;
                ...
                import { BasicOptionItemsHelper } from './BasicOptionItemsHelper.js';
//not GWT import - same folder const BasicOptionItemsHelper = globalThis.admin.taghelpers.BasicOptionItemsHelper;

                
export class BasicOptionItemsHelperFactory extends TagHelperFactory {
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new BasicOptionItemsHelper(hashMap, pageContext);

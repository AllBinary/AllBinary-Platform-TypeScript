...
//not GWT import - same folder const TagHelperFactoryimport { UserHelper } from './UserHelper.js';
//not GWT import - same folder const UserHelper
export class UserHelperFactory extends TagHelperFactory {
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new UserHelper(hashMap, pageContext);

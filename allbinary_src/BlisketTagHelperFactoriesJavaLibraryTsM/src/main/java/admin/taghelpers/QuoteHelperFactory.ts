...
//not GWT import - same folder const TagHelperFactoryimport { QuoteHelper } from './QuoteHelper.js';
//not GWT import - same folder const QuoteHelper
export class QuoteHelperFactory extends TagHelperFactory {
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new QuoteHelper(hashMap, pageContext);

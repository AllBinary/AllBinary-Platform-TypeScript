...
//not GWT import - same folder const TagHelperFactoryimport { StoreFrontsHelper } from './StoreFrontsHelper.js';
//not GWT import - same folder const StoreFrontsHelper
export class StoreFrontsHelperFactory extends TagHelperFactory {

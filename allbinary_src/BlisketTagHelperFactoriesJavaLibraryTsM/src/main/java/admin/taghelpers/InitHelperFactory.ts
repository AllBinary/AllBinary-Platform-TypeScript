...
//not GWT import - same folder const TagHelperFactoryimport { InitHelper } from './InitHelper.js';
//not GWT import - same folder const InitHelper
export class InitHelperFactory extends TagHelperFactory {
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new InitHelper(hashMap, pageContext);

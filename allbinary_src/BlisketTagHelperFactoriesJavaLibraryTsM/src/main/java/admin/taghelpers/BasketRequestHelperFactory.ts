...
//not GWT import - same folder const TagHelperFactory = globalThis.admin.taghelpers.TagHelperFactory;
                ...
                import { BasketRequestHelper } from './BasketRequestHelper.js';
//not GWT import - same folder const BasketRequestHelper = globalThis.admin.taghelpers.BasketRequestHelper;

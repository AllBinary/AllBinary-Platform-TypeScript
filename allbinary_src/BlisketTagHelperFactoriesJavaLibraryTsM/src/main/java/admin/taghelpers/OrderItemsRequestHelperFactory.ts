...
//not GWT import - same folder const TagHelperFactory = globalThis.admin.taghelpers.TagHelperFactory;
                ...
                import { OrderItemsRequestHelper } from './OrderItemsRequestHelper.js';
//not GWT import - same folder const OrderItemsRequestHelper = globalThis.admin.taghelpers.OrderItemsRequestHelper;

                
export class OrderItemsRequestHelperFactory extends TagHelperFactory {
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new OrderItemsRequestHelper(hashMap, pageContext);

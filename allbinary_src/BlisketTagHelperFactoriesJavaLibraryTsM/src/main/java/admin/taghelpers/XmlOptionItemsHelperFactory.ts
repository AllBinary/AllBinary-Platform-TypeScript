...
//not GWT import - same folder const TagHelperFactoryimport { XmlOptionItemsHelper } from './XmlOptionItemsHelper.js';
//not GWT import - same folder const XmlOptionItemsHelper

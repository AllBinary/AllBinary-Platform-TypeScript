...
//not GWT import - same folder const TagHelperFactoryimport { PaymentHelper } from './PaymentHelper.js';
//not GWT import - same folder const PaymentHelper
export class PaymentHelperFactory extends TagHelperFactory {
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new PaymentHelper(hashMap, pageContext);

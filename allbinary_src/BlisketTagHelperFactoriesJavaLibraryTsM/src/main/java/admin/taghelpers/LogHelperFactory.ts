...
//not GWT import - same folder const TagHelperFactoryimport { LogHelper } from './LogHelper.js';
//not GWT import - same folder const LogHelper
export class LogHelperFactory extends TagHelperFactory {
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new LogHelper(hashMap, pageContext);

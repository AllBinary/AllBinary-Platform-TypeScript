...
//not GWT import - same folder const TagHelperFactoryimport { OrderHistoryHelper } from './OrderHistoryHelper.js';
//not GWT import - same folder const OrderHistoryHelper
export class OrderHistoryHelperFactory extends TagHelperFactory {

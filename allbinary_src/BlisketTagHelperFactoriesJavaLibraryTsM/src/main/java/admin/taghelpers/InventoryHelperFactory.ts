...
//not GWT import - same folder const TagHelperFactoryimport { InventoryHelper } from './InventoryHelper.js';
//not GWT import - same folder const InventoryHelper
export class InventoryHelperFactory extends TagHelperFactory {

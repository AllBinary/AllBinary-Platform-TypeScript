...
//not GWT import - same folder const TagHelperFactory = globalThis.admin.taghelpers.TagHelperFactory;
                ...
                import { InventoryRequestHelper } from './InventoryRequestHelper.js';
//not GWT import - same folder const InventoryRequestHelper = globalThis.admin.taghelpers.InventoryRequestHelper;

                
export class InventoryRequestHelperFactory extends TagHelperFactory {
...
public constructor (){
    ...
    public getInstance(hashMap: HashMap<any, any>, pageContext: PageContext): any{
        ...
        try {
                        ...
                        return new InventoryRequestHelper(hashMap, pageContext);

...
//not game specific package import { TagHelperFactory } from '../admin/taghelpers/TagHelperFactory.js';
      const TagHelperFactory = globalThis.admin.taghelpers.TagHelperFactory;
...
//not game specific package import { LicensingException } from '../org/allbinary/logic/system/security/licensing/LicensingException.js';
      const LicensingException = globalThis.org.allbinary.logic.system.security.licensing.LicensingException;
        ...
        import { ValidationViewHelper } from './ValidationViewHelper.js';

export class ValidatedViewHelperFactory extends TagHelperFactory {

...
public constructor (abeClientInformation: AbeClientInformationInterface, transformInfoInterface: TransformInfoInterface)                        
    ...
    var transformInfoObjectConfigInterface: TransformInfoObjectConfigInterface = TransformInfoObjectConfigAndManipulatorFactory.getInstance()!.getInstance(abeClientInformation, transformInfoInterface);

                         as TransformInfoObjectConfigInterface;
        
        
;
    
this.setURIResolver(new CustomUriResolver(transformInfoObjectConfigInterface!.getImportUriPath(), this.getURIResolver();

...
//not GWT import - same folder const StoreFrontAdvertisementsStatisticsInterfaceimport { StoreFrontAdvertisementsStatisticsData } from './StoreFrontAdvertisementsStatisticsData.js';
//not GWT import - same folder const StoreFrontAdvertisementsStatisticsData

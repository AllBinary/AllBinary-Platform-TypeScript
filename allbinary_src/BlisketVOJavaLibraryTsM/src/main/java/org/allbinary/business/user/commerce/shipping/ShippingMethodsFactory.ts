...
//not GWT import - same folder const ShippingMethodsData = globalThis.org.allbinary.business.user.commerce.shipping.ShippingMethodsData;

                import { ShippingMethodData } from './ShippingMethodData.js';
//not GWT import - same folder const ShippingMethodData = globalThis.org.allbinary.business.user.commerce.shipping.ShippingMethodData;

...
//not GWT import - same folder const ColorData = globalThis.org.allbinary.logic.visual.dhtml.style.color.ColorData;

                import { ColorsData } from './ColorsData.js';
//not GWT import - same folder const ColorsData = globalThis.org.allbinary.logic.visual.dhtml.style.color.ColorsData;

...
//not game specific package import { TransactionResultEntity } from '../../org/allbinary/data/tables/user/commerce/money/payment/transaction/TransactionResultEntity.js';
      const TransactionResultEntity = globalThis.org.allbinary.data.tables.user.commerce.money.payment.transaction.TransactionResultEntity;

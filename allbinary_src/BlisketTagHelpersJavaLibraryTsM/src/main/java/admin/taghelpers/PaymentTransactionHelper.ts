...
//not game specific package import { TransactionEntity } from '../../org/allbinary/data/tables/user/commerce/money/payment/transaction/TransactionEntity.js';
      const TransactionEntity = globalThis.org.allbinary.data.tables.user.commerce.money.payment.transaction.TransactionEntity;
...
export class PaymentTransactionHelper extends BasicTable {
...
public constructor (hashMap: HashMap<any, any>, pageContext: PageContext){
    ...
    var success: string = new TransactionEntity().dropTable()!;;
    ...
    var success: string = new TransactionEntity().createTable()!;;

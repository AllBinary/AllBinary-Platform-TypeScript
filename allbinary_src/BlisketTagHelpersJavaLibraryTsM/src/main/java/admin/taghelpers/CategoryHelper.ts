...
//not game specific package import { CategoryEntityFactory } from '../../org/allbinary/data/tables/category/CategoryEntityFactory.js';
      const CategoryEntityFactory = globalThis.org.allbinary.data.tables.category.CategoryEntityFactory;
...
export class CategoryHelper extends BasicTable {

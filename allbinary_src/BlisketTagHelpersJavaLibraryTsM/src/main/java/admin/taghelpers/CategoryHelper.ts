...
import { CategoryEntityFactory } from '../../org/allbinary/data/tables/category/CategoryEntityFactory.js';
      //not GWT import const CategoryEntityFactory = globalThis.org.allbinary.data.tables.category.CategoryEntityFactory;

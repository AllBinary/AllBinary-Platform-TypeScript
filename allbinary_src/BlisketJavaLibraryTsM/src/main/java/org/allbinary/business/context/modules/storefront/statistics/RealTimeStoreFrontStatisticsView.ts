...
//not GWT import - same folder const StoreFrontStatisticsData = globalThis.org.allbinary.business.context.modules.storefront.statistics.StoreFrontStatisticsData;

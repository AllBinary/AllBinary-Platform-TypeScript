...
//not GWT import - same folder const LogConfigsDataimport { LogConfigData } from './LogConfigData.js';
//not GWT import - same folder const LogConfigDataimport { LogConfig } from './LogConfig.js';

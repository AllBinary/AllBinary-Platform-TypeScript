...
//not GWT import - same folder const GeologicalResourceInfoHudPaintableSingletonimport { GeologicalResourceInfoHudPaintable } from './GeologicalResourceInfoHudPaintable.js';

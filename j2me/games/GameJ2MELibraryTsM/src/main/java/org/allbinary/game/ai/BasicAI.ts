...
//not game specific package import { CanvasUtil } from '../../../../org/allbinary/game/displayable/canvas/CanvasUtil.js';
      const CanvasUtil = globalThis.org.allbinary.game.displayable.canvas.CanvasUtil;

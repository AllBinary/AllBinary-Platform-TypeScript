...
import { JsPackage } from '../../../../jsinterop/annotations/JsPackage.js';
      //not GWT import const JsPackage = globalThis.jsinterop.annotations.JsPackage;
...
export interface DemoGameMidletJs {

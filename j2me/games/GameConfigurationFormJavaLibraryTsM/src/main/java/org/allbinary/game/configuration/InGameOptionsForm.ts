...
addChoiceGroup(this, InGameFeatureChoiceGroups.getExclusiveInstance()!.get(), Choice.EXCLUSIVE)
addChoiceGroup(this, InGameFeatureChoiceGroups.getMultipleInstance()!.get(), Choice.MULTIPLE)

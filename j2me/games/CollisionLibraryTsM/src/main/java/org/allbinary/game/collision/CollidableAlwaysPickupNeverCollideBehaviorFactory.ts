...
//not GWT import - same folder const CollidableAlwaysPickupNeverCollideBehavior = globalThis.org.allbinary.game.collision.CollidableAlwaysPickupNeverCollideBehavior;

...
export class NoDecimalTrigTable
    ...
    private readonly noDecimalSin: LongArray

    private readonly noDecimalCos: LongArray

    private readonly noDecimalTan: LongArray
private constructor (){

            super();
            
    var TOTAL_ANGLE: number = AngleFactory.getInstance()!.TOTAL_ANGLE.toInt();
        
        


    var MAX_VALUE: number = (Integer.MAX_VALUE.toLong());
...
var dy = dy
    ...
    var MIN_VALUE: number = (Integer.MIN_VALUE.toLong());
        
        


    var ratio: number = (MAX_VALUE -1).toLong();
...
index > 180; index--)
        {
                        ...
                        for (
    var index: number = (noDecimalTan!.length -1);
...
PreLogUtil.put(stringMaker!.append("screenX: ")!.appendint(screenX)!.append(" screenY: ")!.appendint(screenY)!.append(" targetX: ")!.appendint(targetX)!.append(" targetY: ")!.appendint(targetY)!.toString(), this, METHOD_NAME)
    ...
    var targetY2: number =  -targetY.toInt();
        
        


    var screenX2: number =  -screenX.toInt();
        
        


    var screenY2: number =  -screenY.toInt();

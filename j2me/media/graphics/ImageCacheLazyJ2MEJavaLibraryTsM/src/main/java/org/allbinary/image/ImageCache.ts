...
//not GWT import - same folder const NotHTMLEndProcessor = globalThis.org.allbinary.image.NotHTMLEndProcessor;

                //import { FirstProcessor } from './FirstProcessor.js';
//not GWT import - same folder const FirstProcessor = globalThis.org.allbinary.image.FirstProcessor;

                //import { NotHTMLProcessor } from './NotHTMLProcessor.js';
//not GWT import - same folder const NotHTMLProcessor = globalThis.org.allbinary.image.NotHTMLProcessor;

                //import { HTMLEndProcessor } from './HTMLEndProcessor.js';
//not GWT import - same folder const HTMLEndProcessor = globalThis.org.allbinary.image.HTMLEndProcessor;

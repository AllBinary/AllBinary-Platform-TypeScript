...
//not GWT import - same folder const SimplePathFinderGraphVisitorFactory = globalThis.org.allbinary.game.media.graphics.geography.map.racetrack.SimplePathFinderGraphVisitorFactory;

...
//not GWT import - same folder const GeographicMapCellPositionFactory = globalThis.org.allbinary.media.graphics.geography.map.GeographicMapCellPositionFactory;

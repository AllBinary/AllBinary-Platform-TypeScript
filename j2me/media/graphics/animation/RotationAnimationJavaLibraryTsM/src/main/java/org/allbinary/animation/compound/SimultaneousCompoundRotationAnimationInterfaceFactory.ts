...
//not GWT import - same folder const CompoundAnimationInterfaceFactoryimport { SimultaneousCompoundRotationAnimation } from './SimultaneousCompoundRotationAnimation.js';

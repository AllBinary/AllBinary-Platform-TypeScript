...
//not GWT import - same folder const FeaturedResourceFactoryimport { FeaturedResourceRelativeRelationshipFactory } from './FeaturedResourceRelativeRelationshipFactory.js';

...
KEYCODE_BUTTON_THUMBR= new AndroidGameKey(KeyEvent.KEYCODE_BUTTON_THUMBR, "BUTTON THUMBR");
    
KEYCODE_BUTTON_THUMBL= new AndroidGameKey(KeyEvent.KEYCODE_BUTTON_THUMBL, "BUTTON THUMBL");
    
KEYCODE_BUTTON_START= new AndroidGameKey(KeyEvent.KEYCODE_BUTTON_START, "BUTTON START");
    
KEYCODE_BUTTON_MODE= new AndroidGameKey(KeyEvent.KEYCODE_BUTTON_MODE, "BUTTON MODE");
    
KEYCODE_BUTTON_B= new AndroidGameKey(KeyEvent.KEYCODE_BUTTON_B, "BUTTON B");
    
KEYCODE_BUTTON_A= new AndroidGameKey(KeyEvent.KEYCODE_BUTTON_A, "BUTTON A");
    
KEYCODE_BUTTON_X= new AndroidGameKey(KeyEvent.KEYCODE_BUTTON_X, "BUTTON X");
    
KEYCODE_BUTTON_Y= new AndroidGameKey(KeyEvent.KEYCODE_BUTTON_Y, "BUTTON Y");

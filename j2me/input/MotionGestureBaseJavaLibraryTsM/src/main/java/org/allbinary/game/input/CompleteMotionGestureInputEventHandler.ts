...
//not GWT import - same folder const CompleteMotionGestureInputEventListenerimport { CompleteMotionGestureInputEvent } from './CompleteMotionGestureInputEvent.js';
//not GWT import - same folder const CompleteMotionGestureInputEventimport { CompleteMotionGestureInputEventListenerInterface } from './CompleteMotionGestureInputEventListenerInterface.js';

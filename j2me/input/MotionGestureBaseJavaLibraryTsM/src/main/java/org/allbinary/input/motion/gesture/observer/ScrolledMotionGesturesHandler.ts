...
export class ScrolledMotionGesturesHandler extends BasicEventHandler {
    ...
    private static readonly SINGLETON: ScrolledMotionGesturesHandler = new ScrolledMotionGesturesHandler();

    public static getInstance(): ScrolledMotionGesturesHandler{

...
//not GWT import - same folder const DisplayChangeEventListener = globalThis.org.allbinary.graphics.displayable.event.DisplayChangeEventListener;
...
export class LastDisplayChangeEventHandler extends BasicEventHandler {
    ...
    private static readonly SINGLETON: LastDisplayChangeEventHandler = new LastDisplayChangeEventHandler();

    public static getInstance(): LastDisplayChangeEventHandler{

...
//not GWT import - same folder const Shaderimport { ShaderInitializer } from './ShaderInitializer.js';
//not GWT import - same folder const ShaderInitializerimport { CompositeShaderUpdater } from './CompositeShaderUpdater.js';
//not GWT import - same folder const CompositeShaderUpdaterimport { ModelViewProjection } from './ModelViewProjection.js';
//not GWT import - same folder const ModelViewProjectionimport { NullOpenGLTextureProcessor } from './NullOpenGLTextureProcessor.js';
//not GWT import - same folder const NullOpenGLTextureProcessorimport { OpenGLObject3dProcessor } from './OpenGLObject3dProcessor.js';

...
//not GWT import - same folder const GenericProfileActionJPanelimport { GenericProfileActionData } from './GenericProfileActionData.js';
//not GWT import - same folder const GenericProfileActionData

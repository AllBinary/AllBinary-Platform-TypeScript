...
setViewportView(genericProfileActionsJList)
setText("New")
addActionListener(object: java.awt.event.ActionListener()
                                {
...
setMinimumSize(java.awt.Dimension(500, 300))
...
setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)!.addComponent(genericProfileActionsJPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 336, javax.swing.GroupLayout.PREFERRED_SIZE))
}
    ...
    var defaultListModelHelper: DefaultListModelHelper = this.getGenericProfileActions()!.getDefaultListModelHelper()!;
                        ...
                        if(defaultListModelHelper!.getListModel()!.getSize() > 0)
                                    ...
                                    {
                                    setModel(defaultListModelHelper!.getListModel())
...
var evt = evt
        ...
        try {
            ...
            {
put(this.commonStrings!.EXCEPTION, this, "saveJButtonActionPerformed", e)
}
...
setGenericProfileAction(genericProfileAction)
...
setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)!.addGap(0, 395, Short.MAX_VALUE)!.addComponent(this.getGenericProfileActionJPanel(), javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)!.addGap(0, 256, Short.MAX_VALUE)!.addComponent(this.getGenericProfileActionJPanel(), javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
put("Setting Configuration Profile Actions JPanel", this, "genericProfileActionsJListValueChanged")
...
this.updateProfileActionUI(profileActionNameString)
            ...
            {
put(this.commonStrings!.EXCEPTION, this, "genericProfileActionsJListValueChanged", e)
}
...
add(newActionName)
this.setModel()
setSelectedValue(newActionName, true)
setVisible(false)
this.updateProfileActionUI(newActionName)
} catch(e: Exception)
            {
put(this.commonStrings!.EXCEPTION, this, "okNewProfileActionJButtonActionPerformed", e)
}
...
this.selectFirstElement()
            ...
            {
put(this.commonStrings!.EXCEPTION, this, "deleteActionJButtonActionPerformed", e)
}
...
this.setModel()
                        ...
                        if(this.genericProfileActionsJList!.getModel()!.getSize() > 0)
                                    ...
                                    {
                                    setSelectedValue(this.genericProfileActionsJList!.getModel()!.getElementAt(0), true)

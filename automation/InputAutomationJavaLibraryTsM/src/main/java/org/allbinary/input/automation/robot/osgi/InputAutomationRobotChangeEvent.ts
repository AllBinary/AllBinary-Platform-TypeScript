...
this.this.setInputAutomationRobotInterfaceWrapper(inputAutomationRobotInterfaceWrapper)
}


    public getInputAutomationRobotInterfaceWrapper(): InputAutomationRobotInterfaceWrapper{

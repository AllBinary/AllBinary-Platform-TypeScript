...
export class KeySingletonFactory
    ...
    private static keyArray: number[] = 
                                                        [
                ...
                private static initResult: number = KeySingletonFactory.init();
...
logUtil!.put(commonStrings!.EXCEPTION, "KeySingleFactory", STATIC_BLOCK, e);
    ...
    public static getInstance(index: number): number{
var index = index

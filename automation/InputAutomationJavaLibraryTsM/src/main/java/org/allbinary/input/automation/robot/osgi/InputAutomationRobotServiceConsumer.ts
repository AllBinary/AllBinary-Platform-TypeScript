...
//not GWT import const InputAutomationRobotOSGIServiceVisitor = globalThis.org.allbinary.input.automation.robot.osgi.InputAutomationRobotOSGIServiceVisitor;

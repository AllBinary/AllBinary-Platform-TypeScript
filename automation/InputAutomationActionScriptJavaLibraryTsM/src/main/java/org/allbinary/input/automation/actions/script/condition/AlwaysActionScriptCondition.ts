...
//not GWT import - same folder const AlwaysActionScriptConditionJPanel = globalThis.org.allbinary.input.automation.actions.script.condition.AlwaysActionScriptConditionJPanel;

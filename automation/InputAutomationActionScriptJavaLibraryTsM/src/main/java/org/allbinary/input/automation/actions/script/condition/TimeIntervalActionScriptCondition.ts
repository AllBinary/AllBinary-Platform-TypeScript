...
//not GWT import - same folder const TimeIntervalActionScriptConditionJPanel = globalThis.org.allbinary.input.automation.actions.script.condition.TimeIntervalActionScriptConditionJPanel;

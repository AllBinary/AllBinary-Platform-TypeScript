...
//not GWT import - same folder const MouseActionScriptInputJPanel = globalThis.org.allbinary.input.automation.actions.script.condition.processors.input.MouseActionScriptInputJPanel;
...
//not GWT import - same folder const MouseInputAutomationProcessor = globalThis.org.allbinary.input.automation.actions.script.condition.processors.input.MouseInputAutomationProcessor;

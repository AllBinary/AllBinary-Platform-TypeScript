...
//not GWT import - same folder const GenericProfileActionScriptConditionData = globalThis.org.allbinary.input.automation.actions.script.condition.GenericProfileActionScriptConditionData;

                import { ProfileActionScriptConditionFactory } from './ProfileActionScriptConditionFactory.js';
//not GWT import - same folder const ProfileActionScriptConditionFactory = globalThis.org.allbinary.input.automation.actions.script.condition.ProfileActionScriptConditionFactory;

                import { JMenu } from './JMenu.js';
//not GWT import - same folder const JMenu = globalThis.org.allbinary.input.automation.actions.script.condition.JMenu;

                import { JMenuItem } from './JMenuItem.js';
//not GWT import - same folder const JMenuItem = globalThis.org.allbinary.input.automation.actions.script.condition.JMenuItem;

...
//not GWT import - same folder const GenericInputAutomationAction = globalThis.org.allbinary.input.automation.module.generic.GenericInputAutomationAction;

                import { GenericInputAutomationWorker } from './GenericInputAutomationWorker.js';
//not GWT import - same folder const GenericInputAutomationWorker = globalThis.org.allbinary.input.automation.module.generic.GenericInputAutomationWorker;
